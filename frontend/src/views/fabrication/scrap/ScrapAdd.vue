<template>
  ...
  >
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='选择报废入库记录' v-bind="formItemLayout">
        ...
        <a-col :span="12">
          <a-form-item label='报废主题' v-bind="formItemLayout">
            <a-input v-decorator="[
            'theme',
            { rules: [{ required: true, message: '请输入报废主题!' }] }
            ]"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
